...
| <a onclick="_play('faa1')"> 花 /a/ </a>  | <a onclick="_play('faan1')"> 翻 /a/ </a> | <a onclick="_play('fan1')"> 分 /ɐ/ </a>|
| ------------------------------ | ------------------------------- | ------------------------------ |
| fa                             | faan                            | fan                            |
...
粵拼經常畀人批評用字母 j 嚟表示個發音 <a onclick="_play('jaa1')"> /j/ </a>，就係因爲違背咗呢條原則，因爲大家都習慣咗用字母 y 嚟代表個發音 /j/，用 j 嚟表示就好唔習慣。關於呢一點[下面](#關於-j-同-y)會詳細解釋。
...
|          | <a onclick="_play('seoi6')"> 睡 /sɵi˨/ </a>| <a onclick="_play('deu6')">掉 /tɛːu˨/</a> | <a onclick="_play('oet6')"> 𠰲 /œt˨/</a>|
| -------- | ---------------------------------- | ---------------------------------- | -------------------------------- |
