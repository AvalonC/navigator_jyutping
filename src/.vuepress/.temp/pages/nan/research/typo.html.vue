...
<p>表中部分字有唔止一個建議用字，主要考慮到粵語區唔同地域用字習慣，表示呢幾種用字皆可。</p>
</div>
<table>
    <tr>
        <th>粵拼</th>
    ...
    <td>haa2/haa5</td>
    <td>吓下</td>
    <td><ul><li>「吓」讀 haa2，僅用作語氣詞，例如「吓？係真嘎？」「係噉嘅咩吓？」</li><li>「下」有兩個發音，讀 haa6 個陣表示方向，例如「下面」「下方」；讀 haa5 個陣表示次數，例如「畀我睇下」「試下先」 </li></ul></td>
    </tr>
    <tr>
    <td>hai6</td>
    <td>係系喺繫</td>
